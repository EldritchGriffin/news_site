...
export default async function Hero() {
  ...
  return (
    <>
      <div className="w-full max-w-screen-xl bb">

        <section className="container mx-auto">
          <h2 className="text-xl font-bold mb-4">Main Stories</h2>
          <div className="flex flex-col lg:flex-row gap-2">
            <article className="lg:w-[60%] relative h-[450px] bg-black text-white flex flex-col justify-end">
              <CardPost
            ...
            <div className="lg:w-2/5 grid grid-cols-2 gap-2 h-[450px]">
              {[1, 2, 3, 4].map((_, i) => (
