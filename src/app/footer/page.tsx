...
export default function Footer() {
    ...
    const [inputtphone, SetInputtphone] = useState(0);
    const [Email, SetEmail] = useState("");
    const [Phone, SetPhone] = useState("");
    const [Emailvalid, SetEmailvalid] = useState(1);
    const [Phonevalid, SetPhonevalid] = useState(1);
  return (
        ...
        <div className=''>
            <h5 className="border-b border-[#363636] text-[#ffffff]  font-[Baskervville] text-[20px] font-medium leading-[24px] mb-[15px] mt-0 ml-0 mr-0 py-[10px] md:pt-[0px]" >Newsletter Subscibe</h5>
                ...
                <div className="flex flex-col border-b border-[#363636] mb-3 md:border-b-0 w-full" >
                        ...
                        pattern="[0-9]*"
                        inputMode="numeric"
                        className={`w-full h-[38px] focus:outline-none bg-white py-1 pl-2 text-[16px] font-[Baskervville] ${Phonevalid ? 'focus:shadow-[0_0_0_0.25rem_rgba(13,110,253,.25)]' : 'focus:shadow-[0_0_0_0.25rem_rgba(220,53,69,.25)]' }`} style={{border: inputtphone === 1 ? '1px solid #86b7fe' : 'none', }}  onFocus={() => SetInputtphone(1)} onBlur={() => SetInputtphone(0)}
                        />
                    </div>
                        <div className="mb-3" >
                    <input
                        ...
                        className={`w-full h-[38px] focus:outline-none bg-white py-1 pl-2 text-[16px] font-[Baskervville] ${Emailvalid ? 'focus:shadow-[0_0_0_0.25rem_rgba(13,110,253,.25)]' : 'focus:shadow-[0_0_0_0.25rem_rgba(220,53,69,.25)]' }`} style={{border: inputtext === 1 ? '1px solid #86b7fe' : 'none', }}  onFocus={() => SetInputtext(1)} onBlur={() => SetInputtext(0)}/>
                    </div>
                    {/* <button className='mb-3 text-white bg-[#d42a23] text-[16px] font-[Baskervville] font-normal py-[6px] px-[12px] hover:text-black' onClick={() => (subscriveservicce(Email, SetEmailvalid))}>Subscribe</button> */}
                    <button className='mb-3 text-white bg-[#d42a23] text-[16px] font-[Baskervville] font-normal py-[6px] px-[12px] hover:text-black' >Subscribe</button>
                </div>
                </div>
        </div>
        </div>
